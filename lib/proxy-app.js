...
//TODO: do token based auth for both http and ws server once we have a common secure store
...
function startWSStreamServerIfNeeded(streamUrl) {
  if (deviceStreamUrl !== streamUrl) {
...
process.on('message', function(msg) {
  if (msg.deviceRootUrl) {
    ...
    startWSStreamServerIfNeeded(msg.deviceStreamUrl);
