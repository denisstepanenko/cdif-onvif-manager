...
OnvifDevice.prototype.absoluteMove = function(args, callback) {
  var options = {};
  console.log(args.options.Position.PanTilt.x);
  if (args.options.Position.PanTilt.x) {
    options.x = args.options.Position.PanTilt.x;
  }
  if (args.options.Position.PanTilt.y) {
    options.y = args.options.Position.PanTilt.y;
  }
  if (args.options.Position.Zoom.x) {
    options.zoom = args.options.Position.Zoom.x;
  }
